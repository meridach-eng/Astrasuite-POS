...
<head>
    ...
    <style>
        ...
        .logo { max-height: 85px; max-width: 200px; margin-bottom: 8px; object-fit: contain; }
        ...
        .table-header { background: #f3f4f6; text-align: left; }
            ...
            <td style="width: 60%;">
                ...
                @else
                    <div style="font-size: 20px; font-weight: bold; color: #1f2937; margin-bottom: 5px;">
                        {{ $negocio->nombre_comercial ?? 'Mi Empresa' }}
                    </div>
                @endif

                <div class="company-name">{{ $negocio->nombre_comercial ?? 'Mi Empresa' }}</div>
    ...
    <table class="info-table" style="background: #f9fafb; padding: 10px; border-radius: 4px;">
        <tr>
            <td>
                ...
                NIT: {{ $cotizacion->cliente->nit ?? 'CF' }} &nbsp;|&nbsp; Teléfono: {{ $cotizacion->cliente->telefono ?? 'N/A' }}<br>
        ...
        <div class="totals-section">
            <table class="totals-table">
                ...
                <tr>
                    ...
                    <td class="text-right">{{ $cotizacion->descuento ? $cotizacion->descuento : 'Q0.00' }}</td>
                </tr>
