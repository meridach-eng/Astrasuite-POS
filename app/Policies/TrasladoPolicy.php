...
class TrasladoPolicy
{
    ...
    {
        return $user->can('update_traslado');
    }
    ...
    {
        return $user->can('delete_traslado');
    }
    ...
    {
        return $user->can('delete_any_traslado');
    }
    ...
    {
        return $user->can('force_delete_traslado');
    }
    ...
    {
        return $user->can('force_delete_any_traslado');
    }
    ...
    {
        return $user->can('restore_traslado');
    }
    ...
    {
        return $user->can('restore_any_traslado');
    }
    ...
    {
        return $user->can('replicate_traslado');
    }
    ...
    {
        return $user->can('reorder_traslado');
    }
}
